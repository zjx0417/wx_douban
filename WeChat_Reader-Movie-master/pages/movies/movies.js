...
Page({
  ...
  onLoad:function(event){
    //正在热映api
    var in_theaters = app.globalData.doubanBase + "/v2/movie/in_theaters?apikey=0df993c66c0c636e29ecbb5344252a4a"+"&start=0&count=3";
    //即将上映api
    var coming_soon = app.globalData.doubanBase + "/v2/movie/coming_soon?apikey=0df993c66c0c636e29ecbb5344252a4a" + "&start=0&count=3";
    //top250 api
...
//点击input搜索框显示搜索页面
  ...
  onBindBlur:function(event){
    ...
    var searchUrl = app.globalData.doubanBase + "/v2/movie/search?q=" + this.data.value +"&apikey=0df993c66c0c636e29ecbb5344252a4a"
    //调用url
